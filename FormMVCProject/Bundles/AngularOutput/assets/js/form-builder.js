...
! function(A) {
                    ...
                    uA = function(A) {
                        var t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
                            ...
                            n = [D("a", null, {
                                ...
                                type: "cut",
                                id: h.lastID + "-cut",
                                className: "cut-button btn fa fa-cut",
                                title: p.cutButtonTooltip
                            })];
    ...
    19: function(A, e) {
        ...
        window.fbLoaded = {
            ...
            A = o.safeAttrName(A);
            var t; //e.replace(",", " ")
            return e && (Array.isArray(e) ? t = o.escapeAttr(e.join(" ")) : ("boolean" == typeof e && (e = e.toString()), t = o.escapeAttr(e.trim()))), e = e ? '="' + t + '"' : "", {
                name: A,
                value: e
            }
            ...
            return (o.camelCase(A.type) || o.camelCase(A.label)) + "_" + e;
        }, o.markup = function(A) {
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "",
            ...
            return camelCase(A.replace(/\s/g, "-").replace(/[^a-zA-Z0-9\[\]\_-]/g, ""))
    ...
    78: function(A, e, t) {
        ...
        e.default = l, a.default.register("button", l), a.default.register(["submit", "reset"], l, "button")
    },
    79: function(A, e, t) {
        "use strict";
    ...
    81: function(A, e, t) {
        ...
        e.default = f, s.default.register(["paragraph", "header"], f), s.default.register(["p", "blockquote"], f, "paragraph"), s.default.register(["h1", "h2", "h3", "h4", "h5", "h6"], f, "header")
    },
    82: function(A, e, t) {
        "use strict";
...
//                    }
                    this.classConfig.css && (this.css = this.classConfig.css), this.editorOptions = {
                        height: 250,
                        paste_data_images: !0,
                        plugins: ["advlist autolink lists link image charmap print preview anchor textcolor", "searchreplace visualblocks code fullscreen", "insertdatetime media table contextmenu paste code"],
                        toolbar: "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | table | forecolor backcolor"
                    }
                }, e.prototype.build = function() {
                    var A = this.config,
                        e = A.value,
